...
\begin{itemize}
    ...
    \item \textbf{Compuerta NOT:} Se sintetiza explotando la irreversibilidad del sistema analizada en el Capítulo 2 (ver figura \ref{fig:jardin_del_eden}). % TODO: Verificar etiqueta del diagrama de estados Jardín del Edén en el capítulo 2. 
