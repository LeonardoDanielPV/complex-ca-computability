...
def main():
    ...
    ax.text(1.2, header_y + .2, "Dominio Continuo", **header_style)
    ax.text(3.85, header_y + .2, "Transición Algebraica", **header_style)
    ax.text(6.4, header_y + .2, "Dominio Discreto", **header_style)
