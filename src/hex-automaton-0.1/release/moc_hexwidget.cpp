...
namespace {
struct qt_meta_tag_ZN9HexWidgetE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9HexWidgetE = QtMocHelpers::stringData(
    "HexWidget",
    "step",
    "",
    "randomize"
...
Q_CONSTINIT static const uint qt_meta_data_ZN9HexWidgetE[] = {
...
Q_CONSTINIT const QMetaObject HexWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9HexWidgetE.offsetsAndSizes,
    qt_meta_data_ZN9HexWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9HexWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *HexWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9HexWidgetE.stringdata0))
